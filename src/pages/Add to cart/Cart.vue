<template>
  <div>
    <div class="max-w-screen-xl mx-auto">
      ...
      <div
        v-if="cart.length === 0"
        class="flex items-center justify-center py-40 text-lg text-white font-semibold rounded-full"
      >
        <div class="text-center">
          ...
          <a
            href="/"
            class="text-white py-3 px-6 font-serif text-sm rounded-lg bg-green-600 hover:bg-green-700 hover:text-green-600"
            >បន្តទិញទំនិញ</a
          >
        </div>
      </div>
      ...
      <div v-else>
        <form>
          <div class="flex items-center mb-4">
            <a href="/">
              <h3
                class="ml-2 text-lg text-white font-semibold bg-green-500 py-2 px-12 rounded-full"
              >
                បន្តទិញទំនិញ
              </h3>
            </a>
          ...
          <div class="max-w-screen-xl mx-auto">
            <div class="flex flex-col lg:flex-row gap-6">
              <div
                class="bg-slate-50 rounded-lg overflow-x-auto p-4 flex-1 shadow-lg"
              >
                <div class="flex items-center mb-4 justify-between">
                  <div class="flex">
                    <a href="/">
                      <h3 class="ml-2 text-lg font-semibold text-green-500">
                        Shopping - Online PHNOM PENH
                      </h3>
                    </a>
                  </div>
                  <div class="flex">
                    <button class="flex" @click.prevent="removeAllFromCart">
                      <p
                        class="ml-6 text-md text-green-500 cursor-pointer px-2"
                      >
                        លុបចេញពីហាង
                      </p>
                      <img
                ...
                >
                  <div class="flex items-center border-b border-gray-200 py-4">
                    ...
                    <div class="text-center">
                      <p class="ml-6 text-gray-600 whitespace-nowrap">
                        $ {{ item.price }}
                      </p>
                      <p class="ml-6 text-gray-600 whitespace-nowrap">
                        មានទំនិញ
                        <span class="text-red-600">{{ item.qty }}</span>
                        ក្នុងស្តុក
                      </p>
                    </div>
                    <div
                    ...
                    >
                      ...
                      <button
                        ...
                        class="text-gray-500 text-xl hover:text-white rounded-r-md hover:bg-green-400 px-4"
                      >
                        +
                      </button>
                    </div>
                    <div>
                      <p class="ml-6 text-gray-600">
                        ${{
                          (
                    ...
                    <button
                      ...
                      type="button"
                      class="ml-6 w-5 text-md text-red-500"
                    >
                      <img
                        src="https://cdn-icons-png.flaticon.com/512/6861/6861362.png"
                        alt=""
              ...
              <div class="bg-slate-50 rounded-lg p-4 w-full lg:w-1/3 shadow-md">
                <div
                  class="border-t border-b border-gray-200 py-2 flex justify-between"
                >
                ...
                <div class="py-2 flex justify-between">
                  ...
                  <span class="font-semibold"
                    >{{ (subtotal * 41).toFixed(2) }} KHR</span
                  >
                </div>
                <div class="py-2 flex justify-between">
...
export default {
  ...
  computed: {
    ...
    totalcount() {
      return this.cart.reduce((sum, item) => sum + 1, 0);
    },
    totalDiscount() {
      return this.cart.reduce(
